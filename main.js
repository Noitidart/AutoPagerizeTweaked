...
exports.main = function (options, callbacks) {
    ...
    loading_html = 'data:text/html,' + encodeURIComponent(self.data.load('loading.html'))
    error_html = 'data:text/html,' +  encodeURIComponent(self.data.load('error.html'))
...
function postEvent(name) {
    var cs = "var ev = document.createEvent('Event');" +
        "ev.initEvent(" + JSON.stringify(name) + ", true, false);" +
